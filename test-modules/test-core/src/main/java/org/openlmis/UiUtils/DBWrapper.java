...
public class DBWrapper {
  ...
  public void insertProductsForChildCoverage() throws SQLException {
    update("INSERT INTO products\n" +
      ...
      "('VAA',       'a',            'Glaxo and Smith',  'a',              'a',                    'a',          'a',    'antibiotic', 'VAA',   'TDF/FTC/EFV',  'TDF/FTC/EFV',  'TDF/FTC/EFV',    'TDF/FTC/EFV',  '300/200/600',  2,        1,            'Strip',           10,                     10,        30,                   TRUE,                  TRUE,                TRUE,       TRUE,         TRUE,                 TRUE,             TRUE,               1,          2.2,            2,          2,            2,            2,            2,              2,              2,              2,                    2,                    'a',                          'a',          TRUE,     TRUE,       TRUE,         1,                    FALSE,      TRUE),\n" +
