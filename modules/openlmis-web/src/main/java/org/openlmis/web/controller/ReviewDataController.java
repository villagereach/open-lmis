...
public class ReviewDataController extends BaseController {
  ...
  public ResponseEntity<OpenLmisResponse> getDistribution(@RequestBody Distribution distribution, HttpServletRequest request) {
    OpenLmisResponse openLmisResponse = new OpenLmisResponse("distribution", distributionService.getDistributionDTO(distribution, loggedInUserId(request), new DistributionDataFilter(true), true));
