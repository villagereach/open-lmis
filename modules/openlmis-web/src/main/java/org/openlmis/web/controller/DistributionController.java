...
public class DistributionController extends BaseController {
  ...
  public ResponseEntity<OpenLmisResponse> getPreviousDistributionsEpiUseData(@PathVariable Long deliveryZoneId, @PathVariable Long programId,
                                                                    @PathVariable Long currentPeriodId, @PathVariable Integer n) {
    return response("distributions", distributionService.getNPreviousDistributions(deliveryZoneId, programId, currentPeriodId, n, new DistributionDataFilter(true, false, false, false, false, false)));
  }
