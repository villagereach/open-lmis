...
describe('Child coverage', function () {
  ...
  beforeEach(function () {
    ...
    childCoverageLineItem1 = {"id": 5, "facilityVisitId": 3, "vaccination": "BCG", "maleHealthCenter11Months": {value: 1},
  ...
  describe('Apply NR to all', function () {
    ...
    function verifyCoverageLineItemNotRecordedSet(lineItem) {
      expect(lineItem.maleHealthCenter11Months.notRecorded).toBeTruthy();
      expect(lineItem.maleOutreach11Months.notRecorded).toBeTruthy();
      expect(lineItem.maleHealthCenter23Months.notRecorded).toBeTruthy();
      expect(lineItem.maleOutreach23Months.notRecorded).toBeTruthy();
      expect(lineItem.femaleHealthCenter11Months.notRecorded).toBeTruthy();
      expect(lineItem.femaleOutreach11Months.notRecorded).toBeTruthy();
      expect(lineItem.femaleHealthCenter23Months.notRecorded).toBeTruthy();
      expect(lineItem.femaleOutreach23Months.notRecorded).toBeTruthy();
    }
