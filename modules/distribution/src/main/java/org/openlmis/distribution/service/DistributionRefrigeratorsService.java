...
public class DistributionRefrigeratorsService {
  ...
  public RefrigeratorReading getByRefrigeratorIdAndFacilityVisitId(Long refrigeratorId, Long facilityVisitId) {
    return repository.getByRefrigeratorIdAndFacilityVisitId(refrigeratorId, facilityVisitId);
  }
}
